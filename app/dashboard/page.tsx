...
export default function DashboardPage() {
  ...
  const DASHBOARD_PASSWORD = "12345678" // Change this to your preferred password
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#51181E] via-[#6D2028] to-[#51181E] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-[#F6E4CC]/95 backdrop-blur-md rounded-3xl p-8 shadow-2xl border-2 border-[#BC9751]/30">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-[#6D2028] to-[#BC9751] rounded-full mb-3">
                <Lock className="h-10 w-10 text-white" />
              </div>
              <div className="text-xs tracking-[0.2em] uppercase font-semibold text-[#BC9751] mb-2">welcome Kent & Julia</div>
              <h1 className="text-3xl font-serif font-bold text-[#51181E] mb-2">
                Wedding Invitation Dashboard
              </h1>
              <p className="text-[#51181E]/70 font-sans">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#51181E] mb-2 font-sans">
                  Password
                </label>
                <input
                  type="password"
                  ...
                  className="w-full px-4 py-3 border-2 border-[#6D2028]/20 focus:border-[#6D2028] rounded-xl font-sans placeholder:text-[#51181E]/40 transition-all duration-300 focus:ring-4 focus:ring-[#6D2028]/10"
                  autoFocus
                />
              </div>

              {error && (
                <div className="bg-[#6D2028]/10 border-2 border-[#6D2028]/30 rounded-xl p-3 flex items-center gap-2">
                  <AlertCircle className="h-5 w-5 text-[#6D2028]" />
                  <span className="text-[#6D2028] font-semibold text-sm">{error}</span>
                </div>
              )}

              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-[#6D2028] to-[#BC9751] hover:from-[#6D2028] hover:to-[#6D2028] text-white py-3 rounded-xl font-semibold"
              >
                Access Dashboard
              </Button>
            </form>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F6E4CC] to-[#FFFFFF]">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#51181E] via-[#6D2028] to-[#51181E] shadow-lg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
          <div className="bg-white rounded-2xl p-6 shadow-md border border-[#6D2028]/20">
            <div className="flex items-center justify-between mb-2">
              <Users className="h-6 w-6 sm:h-8 sm:w-8 text-[#6D2028]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#51181E]">{stats.totalGuests}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#51181E]/70 font-sans">Total Guests</p>
            <p className="text-xs text-[#51181E]/50 font-sans mt-1">{stats.total} entries</p>
          </div>

          <div className="bg-[#6D2028]/10 rounded-2xl p-6 shadow-md border border-[#6D2028]/20">
            <div className="flex items-center justify-between mb-2">
              <CheckCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#6D2028]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#6D2028]">{stats.attending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#51181E]/70 font-sans">Attending</p>
          </div>

          <div className="bg-[#6D2028]/10 rounded-2xl p-6 shadow-md border border-[#6D2028]/20">
            <div className="flex items-center justify-between mb-2">
              <XCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#6D2028]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#6D2028]">{stats.notAttending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#51181E]/70 font-sans">Not Attending</p>
          </div>

          <div className="bg-[#BC9751]/10 rounded-2xl p-6 shadow-md border border-[#BC9751]/20">
            <div className="flex items-center justify-between mb-2">
              <AlertCircle className="h-6 w-6 sm:h-8 sm:w-8 text-[#BC9751]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#BC9751]">{stats.pending}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#51181E]/70 font-sans">Pending</p>
          </div>

          <div className="bg-[#BC9751]/10 rounded-2xl p-6 shadow-md border border-[#BC9751]/20">
            <div className="flex items-center justify-between mb-2">
              <Bell className="h-6 w-6 sm:h-8 sm:w-8 text-[#BC9751]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#BC9751]">{guestRequests.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#51181E]/70 font-sans">Requests</p>
          </div>

          <div className="bg-[#6D2028]/10 rounded-2xl p-6 shadow-md border border-[#6D2028]/20">
            <div className="flex items-center justify-between mb-2">
              <Crown className="h-6 w-6 sm:h-8 sm:w-8 text-[#6D2028]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#6D2028]">{entourage.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#51181E]/70 font-sans">Entourage</p>
          </div>

          <div className="bg-[#51181E]/10 rounded-2xl p-6 shadow-md border border-[#51181E]/20">
            <div className="flex items-center justify-between mb-2">
              <UserPlus className="h-6 w-6 sm:h-8 sm:w-8 text-[#51181E]" />
              <span className="text-2xl sm:text-3xl font-bold text-[#51181E]">{principalSponsors.length}</span>
            </div>
            <p className="text-xs sm:text-sm text-[#51181E]/70 font-sans">Principal Sponsors</p>
          </div>
        </div>

        {/* Tabs */}
        <div className="bg-white rounded-2xl p-1 sm:p-2 shadow-md border border-[#6D2028]/20 mb-6">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-2">
            <button
              ...
              className={`w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm font-semibold transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2 ${
                activeTab === "guests"
                  ? "bg-gradient-to-r from-[#6D2028] to-[#BC9751] text-white shadow-lg"
                  : "text-[#51181E] hover:bg-[#6D2028]/10"
              }`}
            >
            ...
            >
              ...
              {guestRequests.length > 0 && (
                <span className="absolute -top-1 -right-1 bg-[#6D2028] text-white text-[10px] sm:text-xs font-bold rounded-full min-w-[18px] h-4 sm:min-w-[20px] sm:h-5 px-1 flex items-center justify-center">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-md border border-[#6D2028]/20 mb-6">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-4">
            <div className="flex-1 w-full">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#51181E]/40" />
                <input
                  type="text"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder="Search guests by name or email..."
                  className="w-full pl-10 pr-4 py-2 border-2 border-[#6D2028]/20 focus:border-[#6D2028] rounded-xl font-sans placeholder:text-[#51181E]/40 transition-all duration-300 focus:ring-4 focus:ring-[#6D2028]/10"
                />
              </div>
            </div>
            <Button
              ...
              className="bg-gradient-to-r from-[#6D2028] to-[#BC9751] hover:from-[#6D2028] hover:to-[#6D2028] text-white"
            >
          ...
          {successMessage && (
            <div className="bg-[#6D2028]/10 border-2 border-[#6D2028]/30 rounded-xl p-3 mb-4 flex items-center gap-2">
              <CheckCircle className="h-5 w-5 text-[#6D2028]" />
              <span className="text-[#6D2028] font-semibold text-sm">{successMessage}</span>
            </div>
          )}
        ...
        {/* Guest List */}
        <div className="bg-white rounded-2xl shadow-md border border-[#6D2028]/20 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gradient-to-r from-[#6D2028]/10 to-[#BC9751]/10">
                <tr>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Name</th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Email</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#51181E] font-sans">RSVP</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#51181E] font-sans whitespace-nowrap">
                    <span className="flex items-center justify-center gap-1">
                      <Users className="h-4 w-4" />
                      Guests
                    </span>
                  </th>
                  <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Message</th>
                  <th className="text-center px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#6D2028]/10">
                {filteredGuests.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-[#51181E]/60 font-sans">
                      {isLoading ? (
                  ...
                  filteredGuests.map((guest, index) => (
                    <tr key={index} className="hover:bg-[#6D2028]/5 transition-colors">
                      <td className="px-6 py-4 font-medium text-[#51181E] font-sans">{guest.Name}</td>
                      <td className="px-6 py-4 text-[#51181E]/70 font-sans">
                        {guest.Email && guest.Email !== "Pending" ? guest.Email : "-"}
                      </td>
                      <td className="px-6 py-4 text-center">
                        {guest.RSVP === "Yes" && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#6D2028]/20 text-[#6D2028] rounded-full text-sm font-semibold">
                        ...
                        {guest.RSVP === "Maybe" && (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#BC9751]/20 text-[#BC9751] rounded-full text-sm font-semibold">
                            <AlertCircle className="h-4 w-4" />
                            Maybe
                          </span>
                        )}
                        {!guest.RSVP || guest.RSVP.trim() === "" ? (
                          <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#F6E4CC] text-[#51181E] rounded-full text-sm font-semibold">
                            Pending
                          </span>
                        ) : null}
                      </td>
                      <td className="px-6 py-4 text-center">
                        <span className="inline-flex items-center justify-center px-3 py-1.5 bg-[#6D2028]/20 text-[#6D2028] rounded-full text-sm font-bold min-w-[3.5rem] border border-[#6D2028]/30">
                          {guest?.Guest !== undefined && guest?.Guest !== null && guest?.Guest !== '' 
                            ? (parseInt(String(guest.Guest)) || 1) 
                            : 1}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-[#51181E]/70 font-sans max-w-xs truncate" title={guest.Message || ""}>
                        {guest.Message || "-"}
                      </td>
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="p-2 text-[#6D2028] hover:bg-[#6D2028]/10 rounded-lg transition-colors"
                            title="Edit guest"
                          >
        ...
        {activeTab === "requests" && (
          <>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md border border-[#6D2028]/20 mb-6">
              ...
              {/* Success/Error Messages */}
              {successMessage && (
                <div className="bg-[#BC9751]/10 border-2 border-[#BC9751]/30 rounded-xl p-3 mb-4 flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-[#BC9751]" />
                  <span className="text-[#BC9751] font-semibold text-sm">{successMessage}</span>
                </div>
              )}
                ...
                <table className="w-full">
                  <thead className="bg-gradient-to-r from-[#6D2028]/10 to-[#BC9751]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Email</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Phone</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#51181E] font-sans whitespace-nowrap">
                        <span className="flex items-center justify-center gap-1">
                          <Users className="h-4 w-4" />
                          Guests
                  ...
                  <tbody className="divide-y divide-[#6D2028]/10">
                    {filteredRequests.length === 0 ? (
                      ...
                      filteredRequests.map((request, index) => (
                        <tr key={index} className="hover:bg-[#6D2028]/5 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#51181E] font-sans">{request.Name}</td>
                          <td className="px-6 py-4 text-[#51181E]/70 font-sans">
                          ...
                          <td className="px-6 py-4 text-[#51181E]/70 font-sans max-w-xs truncate">
                            {request.Message || "-"}
                          </td>
                          <td className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                ...
                                className="px-4 py-2 bg-gradient-to-r from-[#6D2028] to-[#BC9751] hover:from-[#6D2028] hover:to-[#6D2028] text-white rounded-lg transition-colors font-semibold text-sm flex items-center gap-2 shadow-md hover:shadow-lg"
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gradient-to-r from-[#6D2028]/10 to-[#BC9751]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Name</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Role Category</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Role Title</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Email</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#6D2028]/10">
                    {filteredEntourage.length === 0 ? (
                      <tr>
                        <td colSpan={5} className="px-6 py-12 text-center text-[#51181E]/60 font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin" />
                      ...
                      filteredEntourage.map((member, index) => (
                        <tr key={index} className="hover:bg-[#6D2028]/5 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#51181E] font-sans">{member.Name}</td>
                          <td className="px-6 py-4 text-[#51181E]/70 font-sans">
                            {member.RoleCategory || "-"}
                          </td>
                          <td className="px-6 py-4 text-[#51181E]/70 font-sans">
            ...
            <div className="bg-white rounded-2xl shadow-md border border-[#6D2028]/20 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gradient-to-r from-[#6D2028]/10 to-[#BC9751]/10">
                    <tr>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Male Principal Sponsor</th>
                      <th className="text-left px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Female Principal Sponsor</th>
                      <th className="text-center px-6 py-4 text-sm font-bold text-[#51181E] font-sans">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[#6D2028]/10">
                    {filteredPrincipalSponsors.length === 0 ? (
                      <tr>
                        <td colSpan={3} className="px-6 py-12 text-center text-[#51181E]/60 font-sans">
                          {isLoading ? (
                            <div className="flex items-center justify-center gap-2">
                              <RefreshCw className="h-5 w-5 animate-spin" />
                      ...
                      filteredPrincipalSponsors.map((sponsor, index) => (
                        <tr key={index} className="hover:bg-[#6D2028]/5 transition-colors">
                          <td className="px-6 py-4 font-medium text-[#51181E] font-sans">{sponsor.MalePrincipalSponsor}</td>
                          <td className="px-6 py-4 text-[#51181E]/70 font-sans">
...
function AddToGuestListModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-[#6D2028]/30">
        <div className="sticky top-0 bg-gradient-to-r from-[#6D2028]/10 to-[#BC9751]/10 px-6 py-4 border-b border-[#6D2028]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#51181E] font-sans">Add to Guest List</h3>
            <button
              onClick={onCancel}
              className="p-2 hover:bg-white/50 rounded-lg transition-colors text-[#51181E]/70 hover:text-[#51181E]"
            >
        ...
        <div className="p-6">
          <div className="mb-6">
            <p className="text-base text-[#51181E] font-sans leading-relaxed">
              <span className="font-bold text-lg">{request.Name}</span> is requesting to join your wedding with a total of{' '}
              <span className="font-bold text-lg text-[#6D2028]">{guestCount}</span>{' '}
              {guestCount === 1 ? 'guest' : 'guests'}.
            </p>
          </div>
          
          <div className="bg-[#F6E4CC]/50 rounded-xl p-4 mb-6 border border-[#6D2028]/20">
            <p className="text-sm font-semibold text-[#51181E] mb-2 font-sans">Request Details:</p>
            <div className="space-y-2 text-sm text-[#51181E]/80 font-sans">
              ...
              {request.Message && (
                <div className="mt-2 pt-2 border-t border-[#6D2028]/20">
          ...
          <p className="text-sm text-[#51181E]/70 mb-6 font-sans">
          ...
          <div className="flex gap-3">
            <Button
              onClick={onConfirm}
              disabled={isLoading}
              className="flex-1 bg-gradient-to-r from-[#6D2028] to-[#BC9751] hover:from-[#6D2028] hover:to-[#6D2028] text-white disabled:opacity-50"
            >
              {isLoading ? (
                <>
...
function EntourageModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-2xl border border-[#6D2028]/30 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-[#6D2028]/10 to-[#BC9751]/10 px-6 py-4 border-b border-[#6D2028]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#51181E] font-sans">{editing ? 'Edit Entourage Member' : 'Add New Entourage Member'}</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-white/50 rounded-lg transition-colors text-[#51181E]/70 hover:text-[#51181E]"
            >
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-[#51181E] mb-2 font-sans">Name *</label>
              <input
                type="text"
                value={formData.Name}
                onChange={(e) => setFormData({ ...formData, Name: e.target.value })}
                className="w-full px-4 py-2 border-2 border-[#6D2028]/20 focus:border-[#6D2028] rounded-xl text-sm font-sans placeholder:text-[#51181E]/40 transition-all duration-300 focus:ring-4 focus:ring-[#6D2028]/10"
                required
              />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-medium text-[#51181E] mb-2 font-sans">Email</label>
              <input
                type="email"
          ...
          <div className="flex gap-3 mt-6">
            <Button
              onClick={onSave}
              disabled={isLoading}
              className="flex-1 bg-gradient-to-r from-[#6D2028] to-[#BC9751] hover:from-[#6D2028] hover:to-[#6D2028] text-white"
            >
              {isLoading ? (
                <>
                  <RefreshCw className="h-4 w-4 mr-2 animate-spin" />
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-2xl border border-[#6D2028]/30 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-[#6D2028]/10 to-[#BC9751]/10 px-6 py-4 border-b border-[#6D2028]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#51181E] font-sans">
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-[#6D2028]/30">
        <div className="sticky top-0 bg-gradient-to-r from-[#6D2028]/10 to-[#BC9751]/10 px-6 py-4 border-b border-[#6D2028]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#51181E] font-sans">Add New Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-white/50 rounded-lg transition-colors text-[#51181E]/70 hover:text-[#51181E]"
            >
        ...
        <div className="p-6">
          <p className="text-sm text-[#51181E]/70 mb-4 font-sans leading-relaxed">
          ...
          <div>
            ...
            <input
              ...
              value={formData.Name}
              onChange={(e) => setFormData({ ...formData, Name: e.target.value })}
              className="w-full px-4 py-3 border-2 border-[#6D2028]/20 focus:border-[#6D2028] rounded-xl text-sm font-sans placeholder:text-[#51181E]/40 transition-all duration-300 focus:ring-4 focus:ring-[#6D2028]/10"
...
function EditGuestModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl border border-[#6D2028]/30 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-[#6D2028]/10 to-[#BC9751]/10 px-6 py-4 border-b border-[#6D2028]/20 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-[#51181E] font-sans">Edit Guest</h3>
            <button
              onClick={onClose}
              className="p-2 hover:bg-white/50 rounded-lg transition-colors text-[#51181E]/70 hover:text-[#51181E]"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border-2 border-[#6D2028]/20 focus:border-[#6D2028] rounded-xl text-sm font-sans bg-white transition-all duration-300 focus:ring-4 focus:ring-[#6D2028]/10"
                required
              >
...
function ConfirmModal({ open, title, message, onCancel, onConfirm }: { open: boolean; title: string; message: string; onCancel: () => void; onConfirm: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl border border-[#6D2028]/30">
        <div className="px-5 py-4 border-b border-[#6D2028]/20">
          <h3 className="text-base sm:text-lg font-bold text-[#51181E]">{title}</h3>
        </div>
        <div className="px-5 py-4 text-sm sm:text-base text-[#51181E]/80">
          {message}
        </div>
        <div className="px-5 py-4 flex justify-end gap-2 border-t border-[#6D2028]/20">
          <button onClick={onCancel} className="px-4 py-2 text-sm rounded-lg border border-[#6D2028]/20 text-[#51181E] hover:bg-[#6D2028]/10 transition-colors">Cancel</button>
          <button onClick={onConfirm} className="px-4 py-2 text-sm rounded-lg bg-[#6D2028] text-white hover:bg-[#6D2028]/90 transition-colors">Delete</button>
        </div>
      </div>
    </div>
  )
